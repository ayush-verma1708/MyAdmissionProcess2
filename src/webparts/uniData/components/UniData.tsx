...
import styles from "./UniData.module.scss";
import type { IUniDataProps } from "./IUniDataProps";
...
export default class UniData extends React.Component<
  IUniDataProps,
  IUniDataState
> {
  private _sp: SPFI;

  constructor(props: IUniDataProps) {
    super(props);
    this.state = {
      countries: [],
      cities: [],
  ...
  public componentDidMount() {
    this.fetchUniversitiesFromSharePointList();
    // this.getUniInfo();
    $(document).ready(() => {
  ...
  public render(): React.ReactElement<IUniDataProps> {
    return (
...
<tr>
  ...
  private async fetchUniversitiesFromSharePointList() {
    try {
