...
import styles from "./ButtonsWebpart.module.scss";
import type { IButtonsWebpartProps } from "./IButtonsWebpartProps";
...
interface IButtonsWebpartState {
  countries: any[];
  cities: any[];
  universities: any[];
  programs: any[];
...
export default class ButtonsWebpart extends React.Component<
  IButtonsWebpartProps,
  IButtonsWebpartState
> {
  private _sp: SPFI;

  constructor(props: IButtonsWebpartProps) {
    super(props);
    this.state = {
      countries: [],
      cities: [],
  ...
  public render(): React.ReactElement<IButtonsWebpartProps> {
    return (
